...
# of the LSTM
sentiment = linear(final_state[-1][-1], 1, name="output")                           # 1 - we want emotion so 6?

sentiment = tf.squeeze(sentiment, [1])

#checking final_state
tf.Print(final_state, [final_state])  # This does nothing
t = tf.Print(final_state, [final_state])  # Here we are using the value returned by tf.Print
